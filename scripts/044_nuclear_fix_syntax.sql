-- NUCLEAR OPTION: Completely recreate profiles table without RLS (Fixed SQL syntax)
...
DELETE FROM profiles_backup a USING profiles_backup b
WHERE a.ctid < b.ctid
AND a.id = b.id;

-- Step 7: Restore data from backup with auth usernames
