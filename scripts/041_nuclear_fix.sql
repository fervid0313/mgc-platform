-- NUCLEAR OPTION: Completely recreate profiles table without RLS
...
-- Step 6: Restore data from backup with auth usernames
INSERT INTO profiles (id, username, email, tag, avatar, bio, trading_style, win_rate, total_trades, social_links, created_at, updated_at)
SELECT 
    pb.id,
...
-- Step 10: Clean up backup (optional)
