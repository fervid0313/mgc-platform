-- COMPLETE FIX: Fix profile creation AND entries-profiles relationship (Fixed PERFORM)
...
PERFORM 'Testing profile creation:' as info;
DO $$
BEGIN
...
PERFORM 'Testing entries load without profile join:' as info;
DO $$
BEGIN
