-- COMPREHENSIVE FIX: Fix profile creation AND entries-profiles relationship
-- This will fix all issues: profile creation, Community display, and entries join
...
SELECT 'Testing entries load without profile join:' as info;
DO $$
BEGIN
