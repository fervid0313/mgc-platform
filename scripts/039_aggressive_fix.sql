-- AGGRESSIVE FIX: Completely remove all RLS and fix Community display
-- This will fix profile creation and Community username display
...
-- Step 3: Try direct system catalog deletion
...
-- Step 6: Update all profiles to use auth metadata usernames
UPDATE profiles p
