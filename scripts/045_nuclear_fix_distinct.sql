-- NUCLEAR OPTION: Completely recreate profiles table without RLS (Using DISTINCT)
...
-- Step 6: Restore data from backup with auth usernames (using DISTINCT to avoid duplicates)
