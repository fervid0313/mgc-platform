...
export default function TradeAnalyticsPage() {
  ...
  const calculateUserStats = (userProfile: any) => {
    ...
    console.log("[ANALYTICS] All entries in space:", currentSpaceId ? entries[currentSpaceId]?.length || 0 : 0)
    console.log("[ANALYTICS] User entries sample:", userEntries.slice(0, 3).map(e => ({
      id: e.id,
      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="flex items-center gap-4 mb-10">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground text-lg mt-1">{userProfile.username}'s detailed trading performance</p>
          </div>
        </div>

        {/* Main Content Area - Full Analytics */}
